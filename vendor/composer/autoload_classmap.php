...
return array(
    ...
    'JB_Action_Scheduler' => $baseDir . '/includes/class-action-scheduler.php',
    'JB_Activator' => $baseDir . '/includes/class-activator.php',
    'JB_Admin' => $baseDir . '/admin/class-admin.php',
    'JB_Blocks' => $baseDir . '/includes/class-blocks.php',
    'JB_Crawler' => $baseDir . '/includes/class-crawler.php',
    'JB_DB_Install' => $baseDir . '/includes/class-db-install.php',
    'JB_Deactivator' => $baseDir . '/includes/class-deactivator.php',
    'JB_Image_Handler' => $baseDir . '/includes/class-image-handler.php',
    'JB_Importer' => $baseDir . '/includes/class-importer.php',
    'JB_Logger' => $baseDir . '/includes/class-logger.php',
    'JB_Meta_Fields' => $baseDir . '/includes/class-meta-fields.php',
    'JB_Plugin' => $baseDir . '/includes/class-plugin.php',
    'JB_Post_Type' => $baseDir . '/includes/class-post-type.php',
    'JB_Public' => $baseDir . '/public/class-public.php',
    'JB_RSS_Parser' => $baseDir . '/includes/class-rss-parser.php',
    'JB_Scraper' => $baseDir . '/includes/class-scraper.php',
    'JB_Scraper_Config' => $baseDir . '/includes/class-scraper-config.php',
    'JB_Settings' => $baseDir . '/includes/class-settings.php',
    'JB_Storage_Migration' => $baseDir . '/includes/class-storage-migration.php',
    'JB_Taxonomies' => $baseDir . '/includes/class-taxonomies.php',
