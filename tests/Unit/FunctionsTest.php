...
class FunctionsTest extends TestCase {
	...
	public function test_parse_checkin_id_from_url() {
		$this->assertSame( '1527514863', jb_parse_checkin_id_from_url( 'https://untappd.com/user/foo/checkin/1527514863' ) );
		$this->assertNull( jb_parse_checkin_id_from_url( 'https://example.com/' ) );
	}
